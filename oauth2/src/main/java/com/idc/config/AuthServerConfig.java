...
import com.idc.config.IdcAuthenticationService;
import com.idc.config.IdcResourceOwnerPasswordTokenGranter;

@Configuration
public class AuthServerConfig extends AuthorizationServerConfigurerAdapter{

	@Autowired
    private IdcAuthenticationService idcAuthenticationService;
	...
	private List<TokenGranter> getDefaultTokenGranters(AuthorizationServerEndpointsConfigurer endpoints) {
		...
		tokenGranters.add(new IdcResourceOwnerPasswordTokenGranter(idcAuthenticationService, tokenServices,
